...
"""autogenerated by genpy from centauro_locomotion_msgs/LegMovementActionResult.msg. Do not edit."""
import sys
...
class LegMovementActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "centauro_locomotion_msgs/LegMovementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','centauro_locomotion_msgs/LegMovementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LegMovementActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = centauro_locomotion_msgs.msg.LegMovementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = centauro_locomotion_msgs.msg.LegMovementResult()
